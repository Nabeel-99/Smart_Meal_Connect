...
const MissingIngredientsCard = ({ recipeDetails }) => {
  return (
    <div className="flex flex-col bg-[#f0f0f0] border-[#e3e3e3] dark:bg-[#0E0F10] gap-1 overflow-y-scroll hide-scrollbar min-w-80 lg:max-w-96 border dark:border-[#1d1d1d] max-h-[200px] rounded-2xl">
