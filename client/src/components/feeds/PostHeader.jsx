...
const PostHeader = ({ firstName, lastName, title, time, recipeId }) => {
  return (
    <div className="flex flex-col items-start border-b border-b-[#e0e0e0]  dark:border-b-[#1d1d1d] w-full pb-4 gap-4">
      <div className="flex items-center gap-4 ">
        <div className="min-w-10 max-w-10 h-10 text-white rounded-full font-bold text-sm text-center flex items-center justify-center bg-[#B678F0]">
          N
        </div>
